...
<!-***************************** ->
<!-STATUS BAR NEEDS TO BE PLACED ->
<!-***************************** ->

<form action="StudentForm2_Help.php">
...
<form>
    ...
    <input type="text" name="dateSigned" value="Today's Date"><br>
