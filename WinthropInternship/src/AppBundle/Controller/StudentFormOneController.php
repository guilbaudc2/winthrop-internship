...
class StudentFormOneController extends Controller
{
    ...
    public function newAction(Request $request, \Swift_Mailer $mailer)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $siteSuperFormURL = "http://54.172.214.20:8080/WinthropInternship/web/app_dev.php/sitesupervisorform";
            $studentFormTwoURL = "http://54.172.214.20:8080/WinthropInternship/web/app_dev.php/studentformtwo";
