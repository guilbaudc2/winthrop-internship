...
$instance->registerPlugin(${($_ = isset($this->services['swiftmailer.mailer.plugin.antiflood']) ? $this->services['swiftmailer.mailer.plugin.antiflood'] : $this->services['swiftmailer.mailer.plugin.antiflood'] = new \Swift_Plugins_AntiFloodPlugin(1, 1)) && false ?: '_'});
