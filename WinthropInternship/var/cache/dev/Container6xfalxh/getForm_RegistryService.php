...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\CareerConsultantFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CareerConsultantFormType']) ? $this->services['AppBundle\Form\CareerConsultantFormType'] : $this->services['AppBundle\Form\CareerConsultantFormType'] = new \AppBundle\Form\CareerConsultantFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\FacultyLiaisonFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FacultyLiaisonFormType']) ? $this->services['AppBundle\Form\FacultyLiaisonFormType'] : $this->services['AppBundle\Form\FacultyLiaisonFormType'] = new \AppBundle\Form\FacultyLiaisonFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\InternationalOfficeFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\InternationalOfficeFormType']) ? $this->services['AppBundle\Form\InternationalOfficeFormType'] : $this->services['AppBundle\Form\InternationalOfficeFormType'] = new \AppBundle\Form\InternationalOfficeFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\SiteSupervisorFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\SiteSupervisorFormType']) ? $this->services['AppBundle\Form\SiteSupervisorFormType'] : $this->services['AppBundle\Form\SiteSupervisorFormType'] = new \AppBundle\Form\SiteSupervisorFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\StudentFormOneType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\StudentFormOneType']) ? $this->services['AppBundle\Form\StudentFormOneType'] : $this->services['AppBundle\Form\StudentFormOneType'] = new \AppBundle\Form\StudentFormOneType()) && false ?: '_'};
}, 'AppBundle\\Form\\StudentFormTwoType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\StudentFormTwoType']) ? $this->services['AppBundle\Form\StudentFormTwoType'] : $this->services['AppBundle\Form\StudentFormTwoType'] = new \AppBundle\Form\StudentFormTwoType()) && false ?: '_'};
